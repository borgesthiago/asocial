...
class DocumentoController extends AbstractController
{
    ...
    /**
     * @Route("/{id}/resposta", name="documento_resposta", methods={"GET","POST"})
     */
    public function resposta(Request $request, Documento $documento): Response
    {
        $form = $this->createForm(DocumentoType::class, $documento);
        $form->handleRequest($request);
        ...
        return $this->render('documento/resposta.html.twig', [
            'documento' => $documento,
            'form' => $form->createView(),
        ]);
    }
